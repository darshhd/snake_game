...
# Game Title
pygame.display.set_caption("Snakes by dd")
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("Snakes by dd",black,300,200)
        text_screen("Press Space to Play!", black, 240, 270)
        pygame.display.update()
        clock.tick(60)
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen("Press x To Quit", red, 300, 300)
            text_screen("Score: " + str(score), red, 360, 350)
